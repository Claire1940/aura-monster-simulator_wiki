...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.aura-monster-simulator.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Aura Monster Simulator Wiki'

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Aura Monster Simulator Wiki',
    description: 'Copyright and intellectual property information for Aura Monster Simulator Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Aura Monster Simulator Wiki',
      description: 'Copyright and intellectual property information for Aura Monster Simulator Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Aura Monster Simulator Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Aura Monster Simulator Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Aura Monster Simulator Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Aura Monster Simulator Developers</strong> - Creators of the Aura Monster Simulator game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Aura Monster Simulator</strong> - Trademark of the game developers</li>
              <li><strong>Aura Monster Simulator Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Aura Monster Simulator Wiki.
            </p>
            ...
            <p>
              ...
              Aura Monster Simulator Wiki<br />
              Email: <a href="mailto:dmca@aura-monster-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@aura-monster-simulator.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Aura Monster Simulator Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Aura Monster Simulator Wiki (aura-monster-simulator.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@aura-monster-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@aura-monster-simulator.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@aura-monster-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@aura-monster-simulator.wiki</a>
            </p>
            <p>
